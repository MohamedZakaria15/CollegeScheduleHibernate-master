...
@WebServlet("/userShow")
public class UserShowScheduling extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("lecturersDistribution",lecturersDistributions);
        req.setAttribute("assistantsDistribution",assistantsDistributions);
        req.getRequestDispatcher("user_show_table.jsp").forward(req,resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(action.equals("searchSections")){
