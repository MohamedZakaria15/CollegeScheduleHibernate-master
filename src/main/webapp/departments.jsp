...
<html lang="en">
    ...
    <body>
        ...
        <div class="page-content" id="content">
            ...
            <!----------------------- Start Departments Table Section ----------------------->
            <div class="container">
                <div class="degreeLecturer mb-5">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 mt-md-2 mt-sm-2 mt-2 col-lg-7"> 
                                    <form class="d-flex" action="/CollegeSchedule_war/Departments" method="get">
                                    ...
                                    <div class="press-btn">
                                        <a href="#addDepartment" data-toggle="modal"><i class="fas fa-user-plus mr-2 add"></i> </a>
                                        <a href="#deleteDepartment" data-toggle="modal"><i class="fas fa-trash-alt mr-2 delete"></i></a>
                                        <a href="#editDepartment" class="edit"  data-toggle="modal"><i class="fas fa-edit mr-2" data-toggle="tooltip" title="Edit"></i></a>  
                                    </div>                                            
                                </div>
                            </div>
                        </div>
                            ...
                            <table id="example"class="table table-striped table-hover diplay nowrap sticky" cellspacing="0" width="100%">
                                ...
                                %>
                                    <tr>
                                        ...
                                        <td class="range-cell"><%=department.getDepartmentName()%></td>
                                        <td>  
                                            <form action="/CollegeSchedule_war/Departments" method="get">
                                                <input type="hidden" name="hidden" value="<%=department.getDepartmentID()%>">
                                                <!-- <a href="#editDepartment" class="edit" data-toggle="modal"><i class="fas fa-edit mr-2" data-toggle="tooltip" title="Edit"></i></a> -->
                                               <button type="submit" value="deleteOne" name="action" class="delete" data-toggle="modal"><i class="fas fa-trash-alt mr-2" data-toggle="tooltip" title="Delete"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                <%}%>
                        ...
                        <!----------------------- End Departments Table Section ----------------------->
                        
                        <!----------------------- Start Add Department Form ----------------------->
                        <div id="addDepartment" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="/CollegeSchedule_war/Departments" method="post">
