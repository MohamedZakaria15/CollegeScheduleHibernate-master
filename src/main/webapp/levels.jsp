            ...
            <div class="container">
                <div class="level mb-5">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 mt-md-2 mt-sm-2 mt-2 col-lg-7"> 
                                    <form class="d-flex" class="d-flex" action="/CollegeSchedule_war/Levels" method="get">
                                    ...
                                    <div class="press-btn">
                                        <a href="#addlevel" data-toggle="modal"><i class="fas fa-user-plus mr-2 add"></i> </a>
                                        <a href="#deletelevel" data-toggle="modal"><i class="fas fa-trash-alt mr-2 delete"></i></a>   
                                        <a href="#editlevel" class="edit"   data-toggle="modal"><i class="fas fa-edit mr-2" data-toggle="tooltip" title="Edit"></i></a>  
                                    </div>                                            
                                </div>
                            </div>
                        </div>
                            ...
                            <table id="example"class="table table-striped table-hover diplay nowrap sticky" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        %>
                                        <td><%=level.getLevelID()%></td>
                                        <td class="range-cell"><%=level.getLevelName()%></td>
                                        <td>  
                                            <form action="/CollegeSchedule_war/Levels" method="get">
                                                <input type="hidden" name="hidden" id="name" value="<%=level.getLevelID()%>">
                                                <!-- <a href="#editlevel" class="edit" data-toggle="modal"><i class="fas fa-edit mr-2" data-toggle="tooltip" title="Edit"></i></a> -->
                        ...
                        <!----------------------- End Levels Table Section ----------------------->
                        
                        <!----------------------- Start Add Level Form ----------------------->
                        <div id="addlevel" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="/CollegeSchedule_war/Levels" method="post">
                                        ...
                                        <div class="modal-body">  
                                            ...
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input type="text" name="name_info" class="form-control" pattern="[a-zA-Z][a-zA-Z\s]*" title="Must be Charachters Only" required>
                                            </div>  
                                        </div>
                        ...
                        <div id="editlevel" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="/CollegeSchedule_war/Levels" method="post">
                                        <div class="modal-header">      
                                        ...
                                        <div class="modal-body">     
                                            ...
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input type="text" class="form-control  "   pattern="[a-zA-Z][a-zA-Z\s]*" title="Must be Charachters Only" name="name_info" required>
                                            </div>  
                                        </div>
                                        <div class="modal-footer">
                                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel" name="Cancel">
                    ...
                    <!----------------------- Start Delete Level Form ----------------------->
                        <div id="deletelevel" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="/CollegeSchedule_war/Levels" method="get">
                                        <div class="modal-header">      
