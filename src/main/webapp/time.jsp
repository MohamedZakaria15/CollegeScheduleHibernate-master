<%@ page import="server.TimeServlet" %>
                        ...
                        <div class="scroll scroll-one">
                            <table id="example"class="table table-striped table-hover diplay nowrap sticky" cellspacing="0" width="100%">
                                <thead id="headerTable">
                                    <tr>
                                        <th class="range-cell3">Start time</th>
                                        <th class="range-cell3">End Time</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <% Time time=(Time) request.getAttribute("time");%>
                                    <tr>
                                        <td class="range-cell3"><%=time.getStart_time()%></td>
                                        <td class="range-cell3"><%=time.getEnd_time()%></td>
                                        <td>  
